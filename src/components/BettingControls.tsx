          ...
          <div className="w-full">
            ...
            <div className="flex gap-2 mb-3 justify-center">
              {quickBetAmounts.map((amount) => (
                <button
                  ...
                  className={`px-3 md:px-4 py-1.5 md:py-2 font-pixel text-xs md:text-sm rounded border-2 transition-all ${
                    betAmount === amount
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 md:px-4 py-2 md:py-2.5 bg-gray-800 text-white font-pixel text-sm md:text-base rounded border-2 border-gray-600 focus:border-neon-green focus:outline-none text-center"
              />
              <button
                onClick={handleBet}
                disabled={betAmount < minBet || betAmount > maxBet || betAmount > balance}
                className="px-4 md:px-6 py-2 md:py-2.5 bg-neon-green text-dark-bg font-pixel text-xs md:text-sm rounded-lg border-2 border-white shadow-neon hover:scale-105 transition-transform cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                BET
              </button>
            </div>
